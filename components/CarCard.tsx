...
const CarCard: React.FC<CarCardProps> = ({ car }) => {
  ...
  return (
    <div className="bg-slate-800 rounded-xl overflow-hidden shadow-lg border border-slate-700 transition-all duration-300 hover:border-sky-500 hover:shadow-sky-900/40 flex flex-col">
      <div className="p-6 flex flex-col">
        {/* Header Section (Always Visible & Clickable) */}
        <div 
          onClick={toggleDetails}
          className="flex flex-col md:flex-row md:items-start md:justify-between gap-3 mb-4 border-b border-slate-700 pb-4 cursor-pointer group"
        >
        ...
        >
            <span className="font-semibold">{showDetails ? 'Ocultar Detalhes' : 'Ver Detalhes e Diferenciais'}</span>
            <svg 
                xmlns="http://www.w3.org/2000/svg" 
                width="20" 
                height="20" 
            ...
            <div className="animate-fade-in">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="bg-slate-900/50 p-3 rounded-lg border border-slate-700/50 flex items-center gap-3">
                        ...
                        <div>
                        <p className="text-xs text-slate-400 uppercase font-semibold tracking-wider">Cidade</p>
                    ...
                    <div className="bg-slate-900/50 p-3 rounded-lg border border-slate-700/50 flex items-center gap-3">
                        ...
                        <div>
                        <p className="text-xs text-slate-400 uppercase font-semibold tracking-wider">Estrada</p>
